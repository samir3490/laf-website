...
type PageHeaderProps = {
  title: string;
  /** Override org tagline only when a page needs a different line (rare). */
  subtitle?: string;
};

export default function PageHeader({ title, subtitle }: PageHeaderProps) {
  const tagline = subtitle ?? getSite().tagline;
  return (
    <section className="bg-laf-navy text-white py-16 md:py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        <p className="mt-4 text-lg text-white/85 max-w-2xl mx-auto">{tagline}</p>
