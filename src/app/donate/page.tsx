...
export const metadata: Metadata = {
  title: "Donate",
  description: "Support the Lata Agrawal Foundation — every contribution brings hope and change.",
};
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid lg:grid-cols-2 gap-12">
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-laf-muted">
                Click the Donate button below to make a secure payment.
              </p>
              <div className="mt-4">
            ...
            <div className="rounded-xl border border-laf-border bg-white p-6">
              ...
              <ul className="mt-4 space-y-1 text-sm text-laf-muted">
          ...
          <div className="text-center">
            <h2 className="text-xl font-semibold text-laf-navy mb-4">UPI / QR Code</h2>
            <p className="text-sm text-laf-muted mb-6">
              Scan with your preferred payment app for a quick, secure donation.
            </p>
            <div className="relative mx-auto w-64 h-[420px] rounded-xl overflow-hidden shadow-lg border border-laf-border">
              <Image
                src={QR_IMAGE}
